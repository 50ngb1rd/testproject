...
public class Movement : MonoBehaviour
{
    ...
    string text2 = "Insufficient power to machine. 2 power cores needed.";
    string text3 = "1 power core inserted. 1 power core needed.";
    ...
    public IEnumerator PowerCoreInsert()
    {
        ...
        yield return StartCoroutine(MoveObject.use.Translation(powerCore.transform, newPosition, 3f, MoveObject.MoveType.Time));
    }

    public IEnumerator PowerCore2Insert()
    {
    ...
    {
        StartCoroutine(PowerCore2Insert());
    }
